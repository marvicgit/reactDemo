...
import mcdcoder.com.repository.ClienteRepository;
...
/**
 * REST controller for managing {@link mcdcoder.com.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingCliente -> {
                    ...
                    if (cliente.getReferencia() != null) {
                        existingCliente.setReferencia(cliente.getReferencia());
                    }
                    if (cliente.getLatitude() != null) {
                        existingCliente.setLatitude(cliente.getLatitude());
                    }
                    if (cliente.getLongitude() != null) {
                        existingCliente.setLongitude(cliente.getLongitude());
                    }
