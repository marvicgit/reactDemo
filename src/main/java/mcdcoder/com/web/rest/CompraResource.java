...
import mcdcoder.com.repository.CompraRepository;
...
/**
 * REST controller for managing {@link mcdcoder.com.domain.Compra}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CompraResource {
    ...
    public ResponseEntity<List<Compra>> getAllCompras(Pageable pageable) {
        ...
        Page<Compra> page = compraRepository.findAll(pageable);
