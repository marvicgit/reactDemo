...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mcdcoder.com.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mcdcoder.com.repository.UserRepository.USERS_BY_EMAIL_CACHE);
