...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPRADETALLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPRADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPRADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPRADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPRADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPRADETALLE actions', async () => {
      const expectedActions = [
        {
