...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './compra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPRA actions', async () => {
      const expectedActions = [
        {
