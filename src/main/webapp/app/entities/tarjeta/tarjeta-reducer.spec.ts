...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tarjeta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARJETA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARJETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARJETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARJETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARJETA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARJETA actions', async () => {
      const expectedActions = [
        {
