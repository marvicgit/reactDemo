...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENTADETALLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VENTADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VENTADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VENTADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VENTADETALLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VENTADETALLE actions', async () => {
      const expectedActions = [
        {
