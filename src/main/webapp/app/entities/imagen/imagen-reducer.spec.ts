...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './imagen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGEN actions', async () => {
      const expectedActions = [
        {
