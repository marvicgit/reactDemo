...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './variante.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VARIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VARIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VARIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VARIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VARIANTE actions', async () => {
      const expectedActions = [
        {
