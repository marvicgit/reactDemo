...
import mcdcoder.com.domain.Venta;
import mcdcoder.com.repository.VentaRepository;
...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fecha(DEFAULT_FECHA).descuento(DEFAULT_DESCUENTO).total(DEFAULT_TOTAL);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fecha(UPDATED_FECHA).descuento(UPDATED_DESCUENTO).total(UPDATED_TOTAL);
        return venta;
    }
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.fecha(UPDATED_FECHA).descuento(UPDATED_DESCUENTO).total(UPDATED_TOTAL);
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.descuento(UPDATED_DESCUENTO);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fecha(UPDATED_FECHA).descuento(UPDATED_DESCUENTO).total(UPDATED_TOTAL);
