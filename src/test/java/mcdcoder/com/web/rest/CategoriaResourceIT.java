...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
        return categoria;
    }
    ...
    void putNewCategoria() throws Exception {
        ...
        updatedCategoria.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
    ...
    void partialUpdateCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedCategoria.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
